          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="relative flex items-start">
                  <div className="flex items-center h-5">
                    <input
                      ...
                      className="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded transition-colors duration-300"
                    />
                  </div>
                  <div className="ml-2 text-sm">
                    <label htmlFor="remember-me" className="font-medium text-gray-700 cursor-pointer select-none">
                      Remember me
                    </label>
                  </div>
                </div>
              ...
              <div className="text-sm">
                <Link
                  to="/forgot-password"
                  className="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-300 flex items-center"
                >
